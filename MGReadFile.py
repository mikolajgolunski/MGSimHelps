...
def readerLammpsFile(file_path, start_frame=1):  # TODO Implement additional information that can be found in file
    ...
    with open(file_path, "r") as file:
        for line_nr, line in enumerate(file):
            ...
            if "ITEM: ATOMS" in line:
                command = "atoms"
    if start_frame > len(frames_lines_nr):
...
def readerLammpsDataFile(file_path, control_dict):
